...
public class PodcastController implements Serializable{
    ...
    private List<edu.vt.EntityBeans.podcast> podcast1;
    private List<edu.vt.EntityBeans.podcast> podcast2;
    private List<edu.vt.EntityBeans.podcast> podcast3;
    private List<edu.vt.EntityBeans.podcast> podcast4;
    ...
    */
    ...
    public List<edu.vt.EntityBeans.podcast> getPodcast1() {
        return podcast1;
    }

    public void setPodcast1(List<edu.vt.EntityBeans.podcast> podcast1) {
        this.podcast1 = podcast1;
    }

    public List<edu.vt.EntityBeans.podcast> getPodcast2() {
        return podcast2;
    }

    public void setPodcast2(List<edu.vt.EntityBeans.podcast> podcast2) {
        this.podcast2 = podcast2;
    }

    public List<edu.vt.EntityBeans.podcast> getPodcast3() {
        return podcast3;
    }


    public void setPodcast3(List<edu.vt.EntityBeans.podcast> podcast3) {
        this.podcast3 = podcast3;
    }
    public List<edu.vt.EntityBeans.podcast> getPodcast4() {
        return podcast4;
    }

    public void setPodcast4(List<edu.vt.EntityBeans.podcast> podcast4) {
